              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleFormChange(e, 'planta')}
                    placeholder="Ej: CM, CZ, PL (se usa para generar códigos de mezcla)"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 uppercase"
                    maxLength={5}
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Opcional. Si se define, las mezclas de esta planta tendrán el formato <strong>{formPlanta.prefijo_codigo || 'XX'}1001</strong>, <strong>{formPlanta.prefijo_codigo || 'XX'}1002</strong>…
                  </p>
                </div>
